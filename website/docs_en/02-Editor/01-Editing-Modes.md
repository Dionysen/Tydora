...
Inimark supports two editing modes, corresponding to two different needs: "writing smoothly" and "viewing precisely." You can switch between them at any time during writing without affecting each other.
