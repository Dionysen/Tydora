...
> [!NOTE]
> After moving a file, Inimark updates the link index to keep `[[03-Knowledge-Management/01-Wiki-Links]]` resolving correctly whenever possible. See [[03-Knowledge-Management/05-Link-Index]].
