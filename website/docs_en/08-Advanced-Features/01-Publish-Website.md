...
Inimark can turn your note repository (Vault) into a **static website with a single click**, letting you share your knowledge base, documentation, or digital garden with anyone without setting up a server.
