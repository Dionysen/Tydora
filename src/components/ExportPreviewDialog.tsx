...
<style>
  ...
  const PAGE_SCRIPT = [
    ...
    "var firstEl=el.querySelector('p,h1,h2,h3,h4,h5,h6,pre,blockquote,ul,ol,.callout,table,figure,img,svg,ul[data-type=\"taskList\"]>li');",
    ...
    "var h=rr.height;",
    "if(h<pageContentH)nextY=rr.bottom-pageRect.top;",
    "}",
    "}else{",
    ...
    "if(before-currentY>=pageContentH*0.55)nextY=before;else nextY=cut.bottom;",
    "}",
    "}",
    ...
    "pageContent.style.transform='translateY('+(contentTop-breaks[i]).toFixed(1)+'px)';",
