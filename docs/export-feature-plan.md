...
Inimark 是一个基于 Tauri v2 + React 19 的桌面 Markdown 编辑器（项目内代号 `inimark`），使用 TipTap 3 作为 WYSIWYG 编辑器、CodeMirror 6 作为源码编辑器，并支持 Mermaid 图表、markmap 思维导图、Callout、Wiki-Link、代码高亮、本地图片等富内容。
