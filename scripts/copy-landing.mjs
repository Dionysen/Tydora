...
try {
  ...
  console.log("⚠️ Preview image not found, skipping");
}
...
<head>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .code-preview.docs-image-preview {
      background: #ffffff;
    }
    .code-preview.docs-image-preview .docs-image-container {
      width: 100%;
      height: auto;
      overflow: hidden;
      background: #fafafa;
    ...
    .code-preview.docs-image-preview .docs-image-container img {
      width: 100%;
      height: auto;
      display: block;
      object-fit: contain;
...
<section style="padding: 0 24px; margin-top: -80px; position: relative; z-index: 2;">
  <div class="code-preview docs-image-preview">
    <div class="docs-image-container">
      <img src="zjm.png" alt="Tydora 文档预览" />
    </div>
  </div>
</section>
